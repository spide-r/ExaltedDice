...
public class DiceRoll extends SlashCommand {
    //todo diceroll and damageroll are copying basically the same thing - resolve code duplication issue
    public DiceRoll(){
        this.name = "roll";
        this.help = "Rolls a die. 10's count as 2 hits.";
    ...
    protected void execute(SlashCommandEvent event) {
        ...
        Roll roll = new Roll(amount, successes, target, label, privateRoll);
